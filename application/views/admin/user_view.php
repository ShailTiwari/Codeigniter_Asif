...
<body id="page-top" class="index" style="background-image: url(<?php echo base_url('resources/img/education.png')?>);">
                            ...
                            <div class="modal-body" style="text-align: center">
                               <!--  <h2>Admin Login</h2>
                                ...
                                <div class="panel panel-warning" style="text-align: left;">
                                    ...
                                    <a class="btn btn-success" href="<?php echo base_url('index.php/Admin/AdminLogin')?>" style="float: right;"><h4>Admin Login</h4></a>
                                    <h3>User Login</h3>
                                </div>
                                <div><center><img src="<?php echo base_url('resources/img/user-icon.png')?>"></center></div>
